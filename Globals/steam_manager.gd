...
func read_all_p2p_msg_packets(read_count: int = 0) -> void:
...
func send_voice_data(voice_data: PackedByteArray) -> void:
	send_p2p_packedt(1 , {"voice_data": voice_data, "steam_id": STEAM_ID, "username": STEAM_USERNAME})
